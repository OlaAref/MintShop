...
public class SettingController {
	...
	public String saveGeneralSettings(@RequestParam("photo") MultipartFile multipartFile,
									  HttpServletRequest request,
									  RedirectAttributes redirectAttributes) throws IOException {
		
		GeneralSettingBag generalSettingsBag = settingService.getGeneralSettings();
