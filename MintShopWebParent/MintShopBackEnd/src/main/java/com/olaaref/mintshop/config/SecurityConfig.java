...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.authorizeRequests()
				...
				.antMatchers("/product/list", "/product/page/**", "/product/details/**").hasAnyAuthority("Admin", "Editor", "Sales", "Shipper")
				.antMatchers("/product/toAdd", "/product/delete/**", "/product/**/enabled/**").hasAnyAuthority("Admin", "Editor")
				...
				.antMatchers("/shippingRate/**", "/order/**", "/shippingRates/**", "/customer/**").hasAnyAuthority("Admin", "Sales")
